...
def get_data(filters):
    ...
    data = []
    totals = {'sales_person':'TOTAL','tot_carton': 0, 'conv_qty': 0, 'unique_customers': 0, 'invoices': 0, 'drop_size': 0,'sku': 0,'amount': 0}
    ...
    gd = [{'sales_person': k, **v} for k, v in grouped_data.items()]
    for i in gd:
